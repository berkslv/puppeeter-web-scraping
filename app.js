...
async function sendMail(Percent,Amount,Profit){
    var transporter = nodemailer.createTransport({
      ...
      var mailOptions = {
        ...
        subject: 'Günün kazancı',
        html: `
                Kar Oranı: <h3 style="display: inline; font-family: Arial, Helvetica, sans-serif;">${Percent} %</h3>
            <br>
            <hr>
                Kar: <h3 style="display: inline; font-family: Arial, Helvetica, sans-serif;">${Amount} &#8378;</h3>
            <br>
            <hr>
                Güncel miktar: <h3 style="display: inline; font-family: Arial, Helvetica, sans-serif;">${Profit} &#8378;</h3>
        `
      };
